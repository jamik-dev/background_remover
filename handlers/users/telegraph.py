...
async def photo_handler(msg: types.Message):
    ...
    await msg.reply_document(document=new_photo, caption="Fayl <b>@fonsiz_rasmbot</b>'dan olindi")
    await msg.reply_photo(new_photo, caption="Rasm <b>@fonsiz_rasmbot</b>'dan olindi")